...
class CommonWordTableViewCell: UITableViewCell {
    ...
    func layoutUI() {
        ...
        commonWordLabel = UILabel(frame: CGRect(x:15,y:0,width:fullScreenSize.width-50,height: 30))
        commonWordLabel?.font = UIFont.systemFont(ofSize: 14)
//        commonWordLabel?.text = "这是一个常用语"
        self.addSubview(commonWordLabel!)
        
        dateLabel = UILabel(frame: CGRect(x:15,y:32,width: fullScreenSize.width-50,height:30))
